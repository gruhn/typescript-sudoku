...
const pairwiseDifferentProof :
  [ True, True, True, True, True, True, True, True, True, True 
	, True, True, True, True, True, True, True, True, True, True 
	, True, True, True, True, True, True, True, True, True, True 
	, True, True, True, True, True, True, True ]
= [ absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd 
	, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd 
	, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd, absurd 
	, absurd, absurd, absurd, absurd, absurd, absurd, absurd ]

const testPairwiseDifferent : PairwiseDifferent<1,2,3,4,5,6,7,8,9> = pairwiseDifferentProof
