...
type NotEquals<X, Y> = X extends Y ? (Y extends X ? False : True) : True
...
type PairwiseDifferent<
  ...
  X4, X5, X6,
  X7, X8, X9
> = NotEquals<X1, X2> & NotEquals<X1, X3> & NotEquals<X1, X3>
  & NotEquals<X1, X4> & NotEquals<X1, X5> & NotEquals<X1, X6>
  & NotEquals<X1, X7> & NotEquals<X1, X8> & NotEquals<X1, X9>

  & NotEquals<X2, X3> & NotEquals<X2, X4> & NotEquals<X2, X5>
  & NotEquals<X2, X6> & NotEquals<X2, X7> & NotEquals<X2, X8>
  & NotEquals<X2, X9>

  & NotEquals<X3, X4> & NotEquals<X3, X5> & NotEquals<X3, X6>
  & NotEquals<X3, X7> & NotEquals<X3, X8> & NotEquals<X3, X9>

  & NotEquals<X4, X5> & NotEquals<X4, X6> & NotEquals<X4, X7>
  & NotEquals<X4, X8> & NotEquals<X4, X9>

  & NotEquals<X5, X6> & NotEquals<X5, X7> & NotEquals<X5, X8>
  & NotEquals<X5, X9>

  & NotEquals<X6, X7> & NotEquals<X6, X8> & NotEquals<X6, X9>

  & NotEquals<X7, X8> & NotEquals<X7, X9>
